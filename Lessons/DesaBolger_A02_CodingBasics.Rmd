...
```{r basics 2}
#5 and 6.
names <- c("Desa", "Fiona", "Ayoung", "Nusrat", "Emma") #Character
scores <- c(20, 40, 60, 80, 100) #Integer
passed <- c(FALSE, FALSE, TRUE, TRUE, TRUE) #Logical
...
AreYouPassing <- function(dataFrame)
  {
  ifelse(dataFrame$Percentage >= 50,"TRUE","FALSE")
}

#11.

AreYouPassing(df_Scores)
df_Scores
...
> Answer: ifelse worked because it is for a data frame. 
