...
> Answer: yes. The P value is <2e-16 (less than 0.1), so it is statistically significant. 
...
#could adjust below from notes$
#Litter.Totals.groups <- HSD.test(Chem.anova, "plotID", group = TRUE)
...
```{r t.test}
# i feel like i did this in a weird way
...
CP.twosample <- t.test(Crampton$temperature_C ~ Ward$temperature_C)
CP.twosample
#issue is that its saying I have unequal columns. 
