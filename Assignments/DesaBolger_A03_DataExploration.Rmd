...
#They are all bees/wasps! Other (670), Honey Bee (667), Parasitic Wasp (285), Buff Tailed Bumblebee (183), Carniolan Honey Bee (152), Bumble Bee (140), Italian Honeybee (113)
...
#It is a factor because some of the numbers have slashes at the end/ other various symbols, so they can't
...
ggplot(Litter,
       aes(x= dryMass, y = functionalGroup))+
