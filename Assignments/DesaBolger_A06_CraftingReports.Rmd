...
```{r 2018, echo=FALSE, fig.height=4, fig.width=6.5, message=FALSE, warning=FALSE}
#need y axis labeled properly +SPACING 

library(ggplot2)
epa_data$Month <- as.factor(epa_data$Month) 
knitr::opts_chunk$set(fig.align = 'left')
knitr::opts_chunk$set(fig.cap = 'Monthly Ozone, 2018')
...
```{r 2019, echo=FALSE, echo=FALSE, fig.height=4, fig.width=6.5, message=FALSE, warning=FALSE}
library(ggplot2)

knitr::opts_chunk$set(fig.cap = 'Monthly Ozone, 2019')+
knitr::opts_chunk$set(fig.align = 'left')
