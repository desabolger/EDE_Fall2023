...
> ANSWER: 
> EPSG:4269, because it is NAD83.  (answer the rest of these)
...
#Upgrade to a simple feature geometry column by adding a crs #HELP
...
DawsonUTM <- st_as_sfc(Dawson,crs=32614)
class(DawsonUTM)
mapview(DawsonUTM)
