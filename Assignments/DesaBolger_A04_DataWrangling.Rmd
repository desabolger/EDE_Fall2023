...
write.csv(smaller_EPA.PM25.2019.data, row.names = FALSE, 
          file = "./Data/Processed/smaller_EPA_PM25_2019.csv")
write.csv(smaller_EPA.PM25.2018.data, row.names = FALSE, 
          file = "./Data/Processed/smaller_EPA_PM25_2018.csv")
write.csv(smaller_EPA.03.2019.data, row.names = FALSE, 
          file = "./Data/Processed/smaller_EPA_03_2019_data.csv")
write.csv(smaller_EPA.03.2018.data, row.names = FALSE, 
          file = "./Data/Processed/smaller_EPA_03_2018_data.csv")
...
#8  "should it be months or numbers?
...
EPA.data.processed <- 
  ...
  summarise(meanAQI = mean(DAILY_AQI_VALUE), 
            ...
            meanLongitude = mean(SITE_LONGITUDE)) %>% #STD DEV?
...
EPA.data.processed <- pivot_wider(EPA.data.processed, names_from = 
