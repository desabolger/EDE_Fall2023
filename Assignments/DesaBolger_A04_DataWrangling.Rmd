...
#5. For the PM2.5 datasets, fill all cells in AQS_PARAMETER_DESC with "PM2.5" (all cells in this column should be identical). #STUCK HERE

smaller_EPA.03.2018.data$AQS_PARAMETER_DESC <- "PM2.5"
smaller_EPA.03.2019.data$AQS_PARAMETER_DESC <- "PM2.5"
