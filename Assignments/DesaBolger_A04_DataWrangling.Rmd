...
write.csv(smaller_EPA.PM25.2019.data, row.names = FALSE, file = "./Data/Processed/EPAair_O3_PM25_NC1819_ProcessedDone.csv")
```
...
> Answer: na.omit() gets rid of the NAs for PM data as well.
